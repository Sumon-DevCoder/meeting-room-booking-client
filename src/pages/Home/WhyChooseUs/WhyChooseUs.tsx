        ...
        <div className="">
          ...
          >
            ...
            <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <motion.div
                className="rounded-md bg-white dark:bg-neutral-800/50 p-8 text-center shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 dark:hover:scale-105 dark:hover:shadow-xl"
                data-aos="fade-right"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
