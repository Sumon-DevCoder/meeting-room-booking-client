      ...
      <div className="m-auto dark:bg-gray-900 bg-slate-100">
        <section className="relative block px-6 py-10 md:py-10 md:px-10 duration-500">
          <div className="relative mx-auto max-w-7xl text-center">
            {/* Title */}
            <span className="text-gray-900 dark:text-gray-300 font-oswald flex items-center justify-center font-medium uppercase tracking-wider">
              Why Choose Us
            </span>

            <h2
              data-aos="fade-up"
              className="block w-full  bg-clip-text font-bold text-3xl sm:text-4xl  dark:text-gray-300 transition-colors duration-500"
            >
          ...
          <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 pt-14">
            ...
            <div className="rounded-md bg-white dark:bg-neutral-800/50 p-8 text-center hover:shadow-2xl transition duration-500 transform hover:scale-105 dark:hover:scale-105 dark:hover:shadow-xl">
              ...
              <h3
                data-aos="fade-left"
                className="mt-6 text-gray-700 dark:text-gray-200 text-lg font-semibold transition-colors duration-500"
              >
                User-Friendly Design
              </h3>
              <p
                data-aos="fade-right"
                className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-600 dark:text-gray-300 transition-colors duration-500"
              >
