      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mx-auto px-10">
          {teamMembers.map((member: TTeamMember) => (
            <div
              key={member.id}
              className="bg-white rounded-lg shadow-md p-6 transition duration-500 hover:scale-110 space-y-2"
            >
              <img
                src={member.image}
              ...
              />
              <h3 className="text-xl font-semibold text-gray-700 font-oswald">
                {member.name}
              </h3>
