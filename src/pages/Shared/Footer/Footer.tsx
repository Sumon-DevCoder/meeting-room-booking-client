          ...
          <div className="flex flex-col gap-5 lg:gap-0 justify-between sm:px-[18px] md:flex-row lg:px-10">
            ...
            <div className="md:w-[340px]">
              ...
              <div className="flex gap-4 md:flex-col lg:flex-row">
                <Link
                  to={"/about-us"}
                  className="text-indigo-200 underline hover:text-white md:border-none  border-b-2 border-gray-400 mt-4 inline-block"
                >
                  Privacy Policy
                </Link>
                <Link
                  to={"/about-us"}
                  className="text-indigo-200 underline hover:text-indigo-300 md:border-none border-b-2  border-gray-400 md:mt-0  mt-4 lg:mt-4 inline-block"
                >
                  Terms of Service.
                </Link>
              </div>
