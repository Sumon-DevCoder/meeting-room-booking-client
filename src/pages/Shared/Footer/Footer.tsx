            ...
            <Fade direction="up" duration={2000}>
              <div className="md:w-[340px]">
                ...
                <p className="mt-[18px] text-[15px] font-normal text-white/[80%]">
                  At RoomEase, we strive to redefine your meeting experience.
                  Our mission is to provide seamless booking solutions tailored
                  to your needs, ensuring that every gathering is productive and
                  hassle-free.
                </p>
